...
export default function CheckoutDonacionPage() {
  ...
  return (
    <div className="mx-auto max-w-xl px-6 py-10">
      <h1 className="text-3xl font-bold text-stone-800 heading-decorated-amber">Donar</h1>
      ...
      <form onSubmit={handleSubmit} className="mt-8 space-y-6">
        ...
        <div>
          ...
          <textarea
            ...
            rows={2}
            className="mt-1 w-full rounded-xl border border-stone-200 shadow-[inset_0_1px_2px_rgb(0,0,0,0.04)] p-3 text-sm text-stone-800 placeholder:text-stone-400 focus:border-amber-500 focus:ring-2 focus:ring-amber-500/20 outline-none transition-colors"
          ...
          <div className="mt-2 space-y-2">
            {[
              ...
              <label key={opt.value} className={`flex items-center gap-3 rounded-xl border p-3.5 cursor-pointer transition-all duration-200 ${
                method === opt.value ? 'border-amber-500 bg-amber-50 shadow-sm ring-1 ring-amber-500' : 'border-stone-200 hover:bg-stone-50'
              }`}>
