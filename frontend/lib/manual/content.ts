...

  {
    ...
    processes: [
      ...
      },
      {
        ...
        summary: {
          es: 'Listado de animales filtrable por especie, tamaño, edad, género y energía.',
          en: 'Animal listing filterable by species, size, age, gender, and energy.',
        },
        why: {
    ...
    processes: [
      {
        ...
        summary: {
          es: 'Primer ingreso donde se capturan los datos legales y de contacto del refugio.',
          en: 'First-time flow that captures the shelter legal and contact info.',
        },
        why: {
          es: 'Sin un refugio registrado y aprobado, el usuario refugio no puede publicar animales ni recibir solicitudes.',
          en: 'Without a registered and approved shelter, the shelter user cannot publish animals or receive applications.',
        },
        steps: {
          es: [
            'Tras iniciar sesión, se abre la pantalla de registro del refugio si aún no tienes uno.',
            'Llenar nombre, nombre legal, descripción, ciudad, teléfono, email y sitio web.',
            'Enviar — el refugio queda "Pendiente de aprobación".',
            'Esperar a que un administrador verifique el refugio.',
          ],
          en: [
            'After signing in, the shelter registration screen opens if no shelter exists yet.',
            'Fill in name, legal name, description, city, phone, email, and website.',
            'Submit — the shelter is "Awaiting approval".',
            'Wait for an admin to verify the shelter.',
          ],
        },
