...
import { ADOPTION_TRACK, ADOPTION_MANAGE } from '../helpers/flow-tags';
...
test.describe('Adoption Interview Flow', () => {
  test('adopter sees WhatsApp card and event timeline when status is interview', { tag: [...ADOPTION_TRACK] }, async ({ page }) => {
