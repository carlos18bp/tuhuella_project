...
export default function CampaignCard({ campaign }: CampaignCardProps) {
  return (
    <Link
      ...
      className="group h-full flex flex-col rounded-2xl border border-stone-200/80 bg-white overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 hover:border-stone-300/80 transition-all duration-300 card-amber"
    >
