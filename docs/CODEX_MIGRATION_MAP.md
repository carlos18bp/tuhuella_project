...
Tuhuella migrated from the **Codex plugin/marketplace model** to the **native repo skills model**. The native model is the correct Codex approach: skills live in the repo itself and require no external plugin registry.
...
| `plugins/tuhuella_project-codex/.codex-plugin/plugin.json` | removed |
| `plugins/tuhuella_project-codex/skills/<skill>/SKILL.md` | `.agents/skills/<skill>/SKILL.md` |
...
| Before | After |
|--------|-------|
| `plugins/tuhuella_project-codex/skills/` | `.agents/skills/` |
| `plugins/tuhuella_project-codex/.codex-plugin/` | `.codex/` |
...
| verbose generic SKILL.md content | Tuhuella-specific, concise SKILL.md content |
...
|--------|-------|
| `plugins/tuhuella_project-codex/skills/*` | `.agents/skills/*` |
| `Plugin manifest: plugins/tuhuella_project-codex/.codex-plugin/plugin.json` | `Project config: .codex/config.toml` |
