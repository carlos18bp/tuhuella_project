...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        models_to_delete = [
            ...
            Donation,
            ClinicalHistoryEntry, PostAdoptionFollowUp,
            AdoptionApplication, Favorite, UpdatePost,
            CampaignMessage,
            FAQItem, FAQTopic, BlogPost, Campaign,
            AnimalDiseaseScreening, AnimalStatusHistory,
