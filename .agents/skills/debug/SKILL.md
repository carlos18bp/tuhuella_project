---
name: debug
description: "Read-only diagnosis workflow for Tuhuella bugs, failing flows, or unexpected behavior. Use when the user asks for investigation without applying a fix yet."
